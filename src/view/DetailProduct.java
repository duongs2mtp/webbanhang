...
public class DetailProduct extends javax.swing.JDialog {
    ...
    public DetailProduct(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        if (this.owner.checkSanPham()) {
            ...
            txtCPU.setText(a.getHanSuDung());
            txtRAM.setText(a.getSDT());
            txtROM.setText(a.getNhaCungCap());
            txtGPU.setText(a.getWebsite());
            txtXuatXu.setText(a.getxuatXu());
            cbxloaisp.setSelectedIndex(0);
            txtKichThuocMan.setText(Double.toString(a.getNgayNhapKhoo()));
            txtDungLuongPin.setText(a.getTinhTrangg());
            ...
            txtMainBoard.setText(a.getNgayNhapKhooo());
            txtCongsuatNguon.setText(Integer.toString(a.getTinhTranggg()) + "W");
            txtSoLuong.setText(Integer.toString(a.getsoLuong()));
        }
    }
