...
public class TonKhoForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã Sản Phẩm", "Tên Sản Phẩm", "Số lượng", "Đơn giá", "SĐT", "Hạn Sử Dụng", "Nhà Cung Cấp", "Website", "Xuất xứ" }));
